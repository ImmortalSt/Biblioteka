...
namespace Biblioteka
{
    public partial class MsgBoxError : Form
    {
        ...
        public MsgBoxError(string text, string caption)
        {
            ...
            // фон
            fonMSG.Image = Image.FromFile("img/MsgError.png");
            fonMSG.Location = new Point(0, 0);
            fonMSG.Name = "fonMSGError";
            ...
            label_MSG.BackColor = Color.FromArgb(233, 197, 243); // установка цвета
            ...
            ok.BackColor = Color.FromArgb(233, 197, 243); // установка цвета
